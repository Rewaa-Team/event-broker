...
export const TAG_QUEUE_CHUNK_SIZE = 5;
export const TAG_QUEUE_RETRY_ATTEMPTS = 5;
export const TAG_QUEUE_INITIAL_BACKOFF_MS = 1000;
export const TAG_QUEUE_CHUNK_DELAY_MS = 2000;
